...
Object.assign(I18N_DATA.ui.en, {
  "뉴비들은 딜러는 통찰셋 권장.(일부 구원자 제외하고 파괴셋 채용은 난이도가 높음)":
    "For new players, Insight sets are recommended for damage dealers. (Except for some Saviors, Destruction sets are harder to build.)"
});
      ...
      <section class="equipment-panel" id="equipment-overview">
        <div class="equipment-panel-inner">
          ...
          <ul class="equipment-overview-list">
            ...
            <li>뉴비들은 딜러는 통찰셋 권장.(일부 구원자 제외하고 파괴셋 채용은 난이도가 높음)</li>
          </ul>
